...
class PromptAdapterSelectionWrapper(MultiTaskModelWrapper):

    def __init__(self, model, prompt_models_dict, adapter_dict,
                 active_adapter_dict=None, freeze_model_core=True):
        super().__init__(model)
