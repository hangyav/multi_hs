...
def count_labels(labels_list, classes):
...
def labels_to_class_weights(labels_list, classes):
    """
    :param labels_list: list of labels to calculate frequency
    :param classes: class types
    """
    weights = count_labels(labels_list, classes)
...
# The following is taken from: https://github.com/orparask/VS-Loss/blob/main/class_imbalance/losses.py
